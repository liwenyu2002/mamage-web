...
body, body[theme-mode=dark] .semi-always-light, :host, :host .semi-always-light {
  ...
  --semi-brand-0: 234,245,255;
  --semi-brand-1: 203,231,254;
  --semi-brand-2: 152,205,253;
  --semi-brand-3: 101,178,252;
  --semi-brand-4: 50,149,251;
  --semi-brand-5: 0,119,250;
  --semi-brand-6: 0,98,214;
  --semi-brand-7: 0,79,179;
  --semi-brand-8: 0,61,143;
  --semi-brand-9: 0,44,107;
...
body[theme-mode=dark], body .semi-always-dark, :host([theme-mode=dark]), :host .semi-always-dark {
  ...
  --semi-grey-0: 31,34,38;
  --semi-grey-1: 49,53,59;
  --semi-grey-2: 68,73,79;
  --semi-grey-3: 88,94,100;
  --semi-grey-4: 107,112,117;
  --semi-grey-5: 139,144,149;
  --semi-grey-6: 168,173,177;
  --semi-grey-7: 199,203,206;
  --semi-grey-8: 231,233,234;
...
.semi-markdownRender-component-header.semi-typography.semi-typography-h1 {
  margin-top: 16px;
  margin-bottom: 16px;
}
.semi-markdownRender-component-header.semi-typography.semi-typography-h2 {
  margin-top: 16px;
  margin-bottom: 16px;
}
.semi-markdownRender-component-header.semi-typography.semi-typography-h3 {
  margin-top: 16px;
  margin-bottom: 16px;
}
.semi-markdownRender-component-header.semi-typography.semi-typography-h4 {
  margin-top: 16px;
  margin-bottom: 16px;
}
.semi-markdownRender-component-header.semi-typography.semi-typography-h5 {
  margin-top: 16px;
  margin-bottom: 16px;
}
...
.semi-slider-handle {
  box-shadow: 0px 4px 6px 0px rgba(0, 0, 0, 0.1), 0px 0px 1px 0px rgba(0, 0, 0, 0.3);
  box-sizing: border-box;
  touch-action: none;
  position: absolute;
  width: 24px;

  ...
  constructor(props) {
    ...
    this.renderHandle = () => {
      ...
      const handleContents = !range ? (/*#__PURE__*/_react.default.createElement(_index.default, {
        ...
        "aria-valuemax": max,
        "aria-valuemin": min
      }), handleDot && /*#__PURE__*/_react.default.createElement("div", {
        ...
        "aria-valuemin": min
      }), (handleDot === null || handleDot === void 0 ? void 0 : handleDot[0]) && /*#__PURE__*/_react.default.createElement("div", {
        className: _constants.cssClasses.HANDLE_DOT,
      ...
      }), ((_c = this.props.handleDot) === null || _c === void 0 ? void 0 : _c[1]) && /*#__PURE__*/_react.default.createElement("div", {
        className: _constants.cssClasses.HANDLE_DOT,
    ...
    this.renderStepDot = () => {
      ...
      const stylePos = vertical ? 'top' : 'left';
      const labelContent = marks && Object.keys(marks).length > 0 ? (/*#__PURE__*/_react.default.createElement("div", {

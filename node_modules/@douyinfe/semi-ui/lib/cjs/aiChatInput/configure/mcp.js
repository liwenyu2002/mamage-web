...
const Mcp = /*#__PURE__*/_react.default.memo(props => {
  ...
  const {
    ...
    rest = __rest(props, ["className", "style", "options", "num", "children", "onConfigureButtonClick"]);
  ...
  return /*#__PURE__*/_react.default.createElement(_index.Dropdown, Object.assign({
    ...
    render: /*#__PURE__*/_react.default.createElement(_localeConsumer.default, {
      ...
      }, locale.selected.replace('${count}', String((_a = options.length) !== null && _a !== void 0 ? _a : num))), /*#__PURE__*/_react.default.createElement(_index.Button, {
        theme: 'outline',

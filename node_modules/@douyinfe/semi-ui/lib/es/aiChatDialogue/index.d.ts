...
import DialogueFoundation, { DialogueAdapter, Message } from '@douyinfe/semi-foundation/lib/es/aiChatDialogue/foundation';
...
declare class AIChatDialogue extends BaseComponent<AIChatDialogueProps, AIChatDialogueStates> {
    ...
    static propTypes: {
        ...
        renderConfig: PropTypes.Requireable<object>;

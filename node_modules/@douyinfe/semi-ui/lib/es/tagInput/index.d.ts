...
declare class TagInput extends BaseComponent<TagInputProps, TagInputState> {
    ...
    getAllTags: () => (string | number | boolean | Iterable<React.ReactNode> | React.JSX.Element)[];
    renderTag: (value: any, index: number, sortableHandle?: any) => string | number | boolean | Iterable<React.ReactNode> | React.JSX.Element;
    renderSortTag: (props: RenderItemProps) => string | number | boolean | Iterable<React.ReactNode> | React.JSX.Element;
    onSortEnd: (callbackProps: OnSortEndProps) => void;
    renderTags(): React.JSX.Element;
    blur(): void;
    focus(): void;

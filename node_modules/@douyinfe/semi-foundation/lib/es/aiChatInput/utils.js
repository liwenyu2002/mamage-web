...
export function getAttachmentType(item) {
  var _a, _b;
  const {
    type,
    name,
...
export function isImageType(item) {
  ...
  const suffix = name === null || name === void 0 ? void 0 : name.split('.').pop();
  return ((_a = fileInstance === null || fileInstance === void 0 ? void 0 : fileInstance.type) === null || _a === void 0 ? void 0 : _a.startsWith(strings.PIC_PREFIX)) || strings.PIC_SUFFIX_ARRAY.includes(suffix);
}
...
export function transformSelectSlot(obj) {
  const {
    attrs = {}
  } = obj;
  const {
...
export function transformInputSlot(obj) {
  ...
  return {
    type: 'text',
    text: text !== strings.ZERO_WIDTH_CHAR && text.length ? text : attrs === null || attrs === void 0 ? void 0 : attrs.placeholder
  };
}

...
一个基于 React + Webpack 的全媒体内容管理前端，包含项目图库、图片管理、文本内容编辑和视频剪辑工作台，统一配合生产后端 `/api` 使用。

> 2026-07-26 生产整合版新增视频剪辑、生产项目多选、AI 自动粗剪、时间线编辑、自动保存和 FFmpeg 导出。完整内容见 [更新说明](./RELEASE_NOTES.md)。
